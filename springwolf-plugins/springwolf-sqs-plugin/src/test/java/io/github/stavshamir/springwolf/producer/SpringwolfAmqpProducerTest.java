...
public class SpringwolfAmqpProducerTest {
    private SpringwolfSQSProducer springwolfAmqpProducer;
    ...
    public void setUp() {
        ...
        springwolfAmqpProducer = new SpringwolfSQSProducer(channelsService, Collections.singletonList(rabbitTemplate));
    }
